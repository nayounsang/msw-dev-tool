...
msw-dev-tool-browser set-mock-enabled false --cdp-url http://127.0.0.1:9222 --target <target-id>
msw-dev-tool-browser set-enabled '<handler-id>' false --cdp-url http://127.0.0.1:9222 --target <target-id>
