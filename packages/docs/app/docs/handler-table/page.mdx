...
**Deprecated** 
- This feature's usage has changed since `^2.3.0` version. 
- This section will be deleted in the next major version. 
- Check the latest usage [here](/docs/handler-table#control)
</Callout>
