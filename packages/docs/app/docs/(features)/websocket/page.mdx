...
listener_id="$(
  ...
  "behavior":{"preset":"default"},
  "response":{"type":"send","dataType":"string","value":"temp response","delay":300,"repeat":{"interval":500,"repetitions":3}},
  "customResponse":{"type":"send","dataType":"string","value":"custom response","delay":100}
}' | jq -r '.listener.info.id'
)"
msw-dev-tool --pid <pid> ws-set-listener-behavior "$listener_id" --json '{"preset":"custom response"}'
```
