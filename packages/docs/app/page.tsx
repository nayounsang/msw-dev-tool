    ...
    <main className="overflow-hidden bg-neutral-950 text-white">
        ...
        <div className="mx-auto max-w-6xl px-6 pb-24 pt-20 sm:pb-32 sm:pt-28 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mx-auto mt-7 max-w-2xl text-pretty text-lg leading-8 text-neutral-300 sm:text-xl">
              MSW Dev Tool turns your existing MSW handlers into runtime controls—so
              you can inspect requests, debug edge cases, demonstrate states, and
              verify user flows with confidence.
            </p>
          ...
          <div className="mx-auto mt-16 grid max-w-5xl gap-4 sm:grid-cols-3">
            {[
              ...
              <div key={label} className="rounded-xl border border-white/10 bg-white/[0.04] p-5 text-left shadow-2xl shadow-black/20 backdrop-blur">
      ...
      <section className="border-y border-white/10 bg-neutral-900/50">
        <div className="mx-auto max-w-4xl px-6 py-20 text-center lg:px-8">
          <p className="text-sm font-semibold uppercase tracking-[0.18em] text-orange-300">Why MSW Dev Tool</p>
      ...
      <section className="mx-auto max-w-6xl px-6 py-24 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          <p className="text-sm font-semibold uppercase tracking-[0.18em] text-orange-300">A tighter feedback loop</p>
          <h2 className="mt-4 text-3xl font-semibold tracking-tight sm:text-4xl">
          ...
          <Link href="/docs/how-to-use" className="mt-7 inline-flex items-center gap-2 font-medium text-orange-300 transition hover:text-orange-200">
      ...
      <section className="border-t border-white/10 bg-neutral-900/50">
        <div className="mx-auto grid max-w-6xl gap-10 px-6 py-20 lg:grid-cols-[1.15fr_0.85fr] lg:px-8">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.18em] text-orange-300">Built for the whole mock lifecycle</p>
            <h2 className="mt-4 text-3xl font-semibold tracking-tight sm:text-4xl">One set of handlers. More useful ways to use them.</h2>
            <p className="mt-5 max-w-2xl leading-7 text-neutral-300">
              MSW Dev Tool complements—not replaces—your test runner and browser
              automation. It gives developers and agents a deterministic way to
              place the application in the network state they need before checking
              what users see.
            </p>
          </div>
          <ul className="space-y-3">
            {capabilities.map((capability) => (
              <li key={capability} className="flex gap-3 text-sm leading-6 text-neutral-300">
                <CheckCircle2 className="mt-0.5 shrink-0 text-orange-400" size={18} aria-hidden="true" />
                {capability}
              </li>
            ))}
          </ul>
      ...
      <section className="mx-auto max-w-4xl px-6 py-24 text-center lg:px-8">
        <h2 className="text-3xl font-semibold tracking-tight sm:text-4xl">Build and verify with the network under control.</h2>
        ...
        <Link href="/docs/get-started" className="mt-8 inline-flex items-center gap-2 rounded-lg bg-orange-500 px-6 py-3 font-medium transition hover:bg-orange-400">
